...
- Floor Plan 탭은 Revit Add-in이 동기화한 전체 Floor Plan view 목록과 Room polygon 구역을 표시합니다. Room 구역을 클릭하면 해당 Room 사진 API와 업로드 화면으로 연결됩니다.
...
- Sync Floor Plans가 전체 Floor Plan view와 Room polygon을 백엔드에 업로드합니다.
