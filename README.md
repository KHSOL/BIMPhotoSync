...
- Revit 2025 Add-in에서 프로젝트 연결, Room Sync, Floor Plan view 동기화, Sheet PDF export, Sheet 위 Room polygon overlay 동기화, Room 선택 시 사진 타임라인 조회
...
- Floor Plan 탭은 Revit Add-in이 동기화한 전체 Floor Plan view 목록, Floor Plan PDF 배경, Room polygon 구역을 표시합니다. Room 구역을 클릭하면 해당 Room 사진 API와 업로드 화면으로 연결됩니다.
